...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-blue-50 section">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-6 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <p className="text-lg text-fmt-dark/80 md:text-xl max-w-lg">
              A FMT conecta sua empresa ao futuro com soluções digitais de WordPress, tráfego pago, edição de vídeos e automações com IA.
            </p>
          ...
          <div className="relative lg:h-[500px] flex items-center justify-center animate-fade-in" style={{ animationDelay: "0.4s" }}>
